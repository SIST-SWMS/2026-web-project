   ...
   <form action="../mypage/qna_ok.do" method="post">
	...
	<div class="mb-3">
		...
		<select	class="form-select form-select-lg">
			...
			<option value="[color]Grey [size]250mm">[color]Grey [size]250mm</option>
			<option value="[color]Grey [size]260mm">[color]Grey [size]260mm</option>
			<option value="[color]Grey [size]270mm">[color]Grey [size]270mm</option>
		</select>
	</div>
	...
	<div class="mb-2">
		...
		<input type="text" name="subject" class="form-control form-control-lg" maxlength="30"
			placeholder="30자 이내로 입력해주세요">
	</div>

	<!-- 비밀글 -->
	<div class="form-check mb-3">
		<input class="form-check-input" type="checkbox" id="secret" name="is_secret"> <label
	...
	<div class="mb-4">
		...
		<textarea class="form-control" name="content" rows="6" placeholder="문의할 내용을 입력해주세요"></textarea>
	</div>

	<!-- 버튼 -->
	<div class="d-flex gap-2">
		<a href="#" class="btn btn-outline-secondary btn-lg w-50" onclick="javascript:history.back()">취소</a>
		<button type="submit" class="btn btn-secondary btn-lg w-50">등록</button>		
	</div>
	</form>
</body>
</html>