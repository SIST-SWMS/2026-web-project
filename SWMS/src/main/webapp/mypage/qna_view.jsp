...
<body>
	...
	<div class="border rounded-3 p-4 mb-3">
		...
		<div class="d-flex justify-content-between align-items-center mb-2">
			<span class="badge bg-light text-dark border">${qna.type}</span>
		...
		<div class="text-body-secondary small mb-3">${qna.regDate}</div>

		<%-- 문의 본문 --%>
		<div class="pt-3 border-top" style="white-space: pre-line;">${qna.content}</div>
	</div>
	...
	<c:if test="${qna.answerStatus == 'Y'}">
		...
		<div class="border rounded-3 p-4 bg-light">
			<div class="d-flex align-items-center gap-2 mb-2">
				<span class="badge bg-dark">관리자 답변</span> <span
					class="text-body-secondary small">${qna.answerDate}</span>
			</div>
			<div class="pt-2" style="white-space: pre-line;">${qna.answerContent}</div>
		</div>
	</c:if>
