...
<body>
	...
	<div class="d-flex align-items-center gap-3 pb-4 border-bottom mb-4">
		...
		<div>
			...
			<div class="text-body-secondary small">릴리프 스티치 백팩 M_3Color/
				도난방지 RFID차단 여행가방</div>
		</div>
	</div>
	...
	<div class="mb-4">
		<div class="fw-bold mb-2">
			<span class="text-danger">*</span>상품은 어떠셨나요? <span
				class="text-body-secondary fw-normal">별점을 매겨주세요</span>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-11">
				<textarea class="form-control" name="content" rows="6"
					placeholder="제품에 대해 만족스러웠던 점이나, 디자인·사용감·스타일링·사용 팁 등에 대해 남겨주세요."></textarea>
			</div>
		</div>
	</div>
	...
	<div class="d-flex gap-2 justify-content-center mt-4">
		...
		<button type="button" class="btn btn-dark btn-lg px-5">등록</button>
	</div>
