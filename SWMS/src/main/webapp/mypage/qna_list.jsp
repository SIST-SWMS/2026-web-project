...
<body>
	<div
		...
		<%-- <a href="../mypage/qna.do?goods_no=${vo.goods_no}" class="btn btn-dark">문의하기</a> --%>
	</div>
	<table class="table align-middle">
		<thead>
			<tr class="text-body-secondary">
			    <th class="text-center" style="width: 160px;">상품명</th>
		...
		<tbody>
			...
			<tr>
				<td colspan="5" class="text-center text-body-secondary py-4">등록된 문의가 없습니다.</td>
			</tr>
			</c:if>
			<c:forEach var="vo" items="${list}">
			<tr>
			    <td class="text-center">${vo.goods.goods_name}</td>
				<td class="text-center">${vo.type}</td>				
				<td><a href="../mypage/qna_view.do?qna_no=${vo.qna_no}" class="text-dark text-decoration-none">
						${vo.subject}</a></td>
				<td class="text-center text-body-secondary"><fmt:formatDate value="${vo.created_at}" pattern="yyyy.MM.dd"/></td>
