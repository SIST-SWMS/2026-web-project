	...
	<div class="offcanvas offcanvas-end" data-bs-scroll="true"
		...
		<div class="offcanvas-body">
			<div class="order-md-last">
				...
				<a href="../order/order.do" class="w-100 btn btn-primary btn-lg">Continue to checkout</a>
			</div>
		</div>
	</div>
		...
		<div class="container-fluid">
			<div class="row py-3 border-bottom">
				...
				<div class="col-sm-4 col-lg-3 text-center text-sm-start">
					<div class="main-logo">
						<a href="../main/main.do"> <img src="../resources/images/logo.png"
								...
								<ul
									...
									<li class="nav-item dropdown">
										...
										<ul class="dropdown-menu bg-black text-white" aria-labelledby="pages">
											...
											<li>
												<a href="#" class="dropdown-item text-white">About Us 2
													<span class="badge bg-warning text-dark ms-2">PRO</span>
												</a>
											</li>
										</ul>
