...
<%-- 
  사이트 전체에서 쓰는 SVG 아이콘 모음입니다.
  화면에는 보이지 않으며, 각 페이지에서 <use xlink:href="#아이콘id"> 로 불러 씁니다.
  예) 장바구니 아이콘 -> <use xlink:href="#cart">
  아이콘을 추가/수정하려면 이 파일만 고치면 됩니다.
--%>
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <defs>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="lock" viewBox="0 0 24 24">
		  <path fill="currentColor" d="M17 9V7A5 5 0 0 0 7 7v2a3 3 0 0 0-3 3v7a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-7a3 3 0 0 0-3-3ZM9 7a3 3 0 0 1 6 0v2H9Zm9 12a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1Zm-5-4a1 1 0 0 0-1 1v1a1 1 0 0 0 2 0v-1a1 1 0 0 0-1-1Z" />
	  </symbol>
	  <symbol xmlns="http://www.w3.org/2000/svg" id="eye" viewBox="0 0 24 24">
	  <path fill="currentColor" d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" />
	  </symbol>
	  <symbol xmlns="http://www.w3.org/2000/svg" id="heart-empty" viewBox="0 0 24 24">
		<path fill="currentColor" d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"/>
	  </symbol>
		
	  <symbol xmlns="http://www.w3.org/2000/svg" id="heart-fill" viewBox="0 0 24 24">
